...
?>
<body style="background-color: <?php the_field('background_colour', $jumbotron_ID); ?>;">
        <!--[if lt IE 7]>
...
<div style="background-color: <?php the_field('background_colour', $jumbotron_ID); ?>; background-image:url('http://www.insiderguides.com.au/wp-content/uploads/2012/05/crowd-image-large.jpeg'); background-size: cover; " id="altfreshers">
...
<br />
<div class="container">
  <div class="hero-unit pagination-centered" style="color: background: rgba(255,255,255, 0); background: rgba(0, 0, 0, 0.4); margin-top:25px;">
      <?php   
...
<div class="container">
  <div class="row row-halfgap pagination-centered">
    <h3><a href="#altfreshers" class="scroll" style="color:#777"><i class="icon-chevron-up"></i> Back to the Top! <i class="icon-chevron-up"></i></a></h3>
  </div>
</div>
